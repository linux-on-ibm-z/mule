...
public class MetadataKeyIdObjectResolverTestCase {
  ...
  private void mockQueryModelProp(ParameterModel param) {
    when(param.getModelProperty(QueryModelProperty.class)).thenReturn(empty());
  }
  ...
  public void resolveDsql() throws MetadataResolvingException {
    ...
    when(queryParam.getModelProperty(QueryModelProperty.class))
        .thenReturn(Optional.of(new QueryModelProperty(DsqlQueryTranslator.class)));
