...
public class MetadataExtensionEntityResolver implements QueryEntityResolver {
  ...
  @Override
  public MetadataType getEntityMetadata(MetadataContext context, String keyId) throws MetadataResolvingException {
    switch (keyId) {
      case CIRCLE:
      ...
      default:
        throw new MetadataResolvingException("Invalid metadata key: " + keyId, INVALID_METADATA_KEY);
    }
  }
}
